...
public class WalkerResourceTest {
    ...
    public void testServerIsUp() {
        ...
        given().when().get("/walker").then().statusCode(200);
    }
    @Test
    ...
    @Test
    public void getAllWalkersByDogId(){
        List<WalkerDto> walkerDtoList;

        walkerDtoList = given()
                .contentType("application/json")
                .when()
                .get("/walker/dog/{id}", d1.getId())
                .then()
        ...
        WalkerDto walkerDto1 = new WalkerDto(w1);
        WalkerDto walkerDto2 = new WalkerDto(w2);


        assertThat(walkerDtoList, containsInAnyOrder(walkerDto1,walkerDto2));
    }
